...
const LogoIconUnfilledWhite = ({ size = IconSize.normal }: { size?: IconSize }) => (
    ...
    >
        <title>{'cupcake'}</title>
        <path
            d="M422.84 205.8c-.12-1.22-.09-2.29-.26-3.56C407.15 86.73 328.23 103.78 274.6 85s-14.41-70.63-14.41-70.63C167.89-9.3 96.91 102 96.91 102s72.37 
				58.45 197.63 80.72c61.4 10.95 104.02 12.53 128.3 23.08z"
        />
        ...
        <path
            d="M173 275h269.71c19.63-85.07-28.92-71-148.17-92.23C169.28 160.49 96.91 102 96.91 102c-64 27.83-22.27 100.2-22.27 100.2S108.49 
				242.55 173 275z"
        />
